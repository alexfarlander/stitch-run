 ...
 * Stitch Dictionary
 * 
 * Core terminology and concepts for the Stitch platform.
 * This dictionary is exposed via the MCP server to help AI assistants
 * understand Stitch concepts and provide accurate guidance.
 */

export const STITCH_DICTIONARY = {
  concepts: {
...
export type StitchDictionary = typeof STITCH_DICTIONARY;
