...
async function generateTrackingLink(params) {
    ...
    if (validated.utmMedium)
        url.searchParams.set('utm_medium', validated.utmMedium);
    if (validated.utmCampaign)
        url.searchParams.set('utm_campaign', validated.utmCampaign);
    if (validated.utmContent)
        url.searchParams.set('utm_content', validated.utmContent);
    if (validated.utmTerm)
        url.searchParams.set('utm_term', validated.utmTerm);
    if (validated.redirectTo)
        url.searchParams.set('redirect_to', validated.redirectTo);
