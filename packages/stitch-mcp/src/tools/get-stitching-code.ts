...
function generateNextJsCode(nodeId: string, webhookUrl: string, uptimeUrl: string, assetType: string): string {
...
function generateExpressCode(nodeId: string, webhookUrl: string, uptimeUrl: string, assetType: string): string {
...
function generateFlaskCode(nodeId: string, webhookUrl: string, uptimeUrl: string, assetType: string): string {
    ...
    handler: async (params: unknown) => {
        try {
            ...
            switch (validatedParams.framework) {
                case "nextjs":
                    code = generateNextJsCode(
                        validatedParams.nodeId,
                        webhookUrl,
                        uptimeUrl,
                        validatedParams.assetType
                    );
                    break;
                case "express":
