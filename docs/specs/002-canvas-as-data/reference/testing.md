...
- **API Documentation**: `/docs/features/canvas-as-data/API.md`
- **Architecture Overview**: `/docs/features/canvas-as-data/ARCHITECTURE.md`
- **Mermaid Syntax Guide**: `/docs/features/canvas-as-data/MERMAID.md`
- **Version Management Guide**: `/docs/features/canvas-as-data/VERSION_MANAGEMENT.md`
- **Usage Examples**: `/docs/features/canvas-as-data/EXAMPLES.md`
