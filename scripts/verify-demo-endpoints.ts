...
try {
  const demoScript = require('../src/lib/demo/demo-script');
...
try {
  const financialUpdates = require('../src/lib/metrics/financial-updates');
...
try {
  const clockworkEntities = require('../src/lib/seeds/clockwork-entities');
